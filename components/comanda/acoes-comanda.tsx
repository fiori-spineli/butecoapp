      ...
      <div className="sticky bottom-0 z-20 flex flex-col gap-2.5 border-t border-stone-200 dark:border-stone-800 bg-white dark:bg-stone-900 px-6 pt-4 pb-6 sm:bg-white/95 sm:dark:bg-stone-900/95 sm:backdrop-blur-sm">
        {contaAberta ? (
          <button
            ...
            className="cursor-pointer flex items-center justify-center gap-2 rounded-xl bg-amber-700 hover:bg-amber-600 dark:bg-amber-700 dark:hover:bg-amber-600 px-5 py-3.5 font-bold text-white shadow-xs transition-colors"
          >
