...
export default async function FechamentoPage() {
  ...
  const conteudoRelatorio = (
    <div className="mx-auto w-full max-w-3xl">
      <div className="flex flex-wrap items-end justify-between gap-2 border-b-2 border-stone-800 dark:border-stone-300 pb-3">
        <div>
      ...
      <section className="mt-5 grid grid-cols-2 gap-3 sm:grid-cols-4">
        {[
          ...
          <div
            key={rotulo}
            className="rounded-xl border border-stone-200 dark:border-stone-800 bg-white dark:bg-stone-900 p-3 shadow-xs"
          >
      ...
      <section className="mt-3 grid grid-cols-2 gap-3 rounded-xl border border-stone-200 dark:border-stone-800 bg-white dark:bg-stone-900 p-3 shadow-xs">
        <div>
          <p className="text-[10px] font-bold uppercase tracking-wider text-stone-500 dark:text-stone-400">
        ...
        <>
          <div className="mt-3 overflow-x-auto">
            <table className="w-full min-w-140 border-collapse text-left text-xs">
              <thead>
                <tr className="border-b border-stone-300 dark:border-stone-700 text-[10px] uppercase tracking-wider text-stone-500 dark:text-stone-400">
              ...
              <tfoot>
                <tr className="border-t-2 border-stone-800 dark:border-stone-300 text-xs font-black">
          ...
          <div className="mt-3 space-y-4">
            {abertas.map((comanda) => {
              ...
              return (
                <div
                  key={comanda.id}
                  className="rounded-xl border border-stone-200 dark:border-stone-800 bg-white dark:bg-stone-900 p-4 shadow-xs"
                >
                  ...
                  <div className="mt-2 flex justify-end gap-6 border-t border-stone-200 dark:border-stone-800 pt-2 text-xs">
                    <span>
                      Consumo:{" "}
      ...
      <div className="mt-10 flex flex-wrap gap-8 border-t border-stone-300 dark:border-stone-700 pt-6 text-[11px] text-stone-500 dark:text-stone-400">
        <div className="min-w-50 flex-1">
          <div className="border-b border-stone-400 dark:border-stone-600 pb-6" />
    ...
    <>
      <header className="flex items-center justify-between gap-2 border-b border-stone-200 dark:border-stone-800 bg-white dark:bg-stone-900 px-4 sm:px-6 py-3 sm:py-4">
        ...
        <div className="flex shrink-0 items-center gap-2 sm:gap-3">
          ...
          <BotaoImprimir conteudoParaImprimir={conteudoRelatorio} />
        </div>
      </header>
