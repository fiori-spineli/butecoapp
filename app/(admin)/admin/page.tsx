...
export default async function AdminPage() {
  ...
  const { data, error } = await supabase.rpc("painel_admin_metricas");
  ...
  const metricas = data as TelemetriaAdmin;
  ...
  return (
    <main className="min-h-screen w-full bg-stone-100 dark:bg-stone-950 text-stone-900 dark:text-stone-100 transition-colors p-6 md:p-10">
      <div className="mx-auto max-w-7xl flex flex-col gap-8">
        ...
        {/* 3. SEÇÃO: COMANDOS REMOTOS DE MANUTENÇÃO */}
        <section className="rounded-2xl border border-stone-200 dark:border-stone-800 bg-white dark:bg-stone-900 p-6">
          ...
          <p className="text-xs text-stone-500 dark:text-stone-400 mb-4 max-w-xl">
            Permite liberar travas em tabelas ou reciclar o pooler de conexões sem precisar abrir o dashboard da Supabase.
          </p>
          <AcoesAdmin />
        </section>

        {/* 4. SEÇÃO: TABELA DE TODOS OS BARES ATIVOS */}
          ...
          <div className="p-6 border-b border-stone-200 dark:border-stone-800 flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-stone-500 dark:text-stone-400 mt-0.5">
                Auditoria de estabelecimentos e donos
              </p>
            </div>
